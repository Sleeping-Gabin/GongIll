...
import com.gabin.gongill.databinding.ScheduleFragmentBinding
import com.gabin.gongill.view.adapter.ScheduleAdapter
import com.gabin.gongill.view.callback.SimpleScheduleCallback
import com.gabin.gongill.view.listener.OnPlayDragListener
...
class ScheduleFragment : Fragment(), OnPlayDragListener {
	...
	override fun onTouchItem(play: Play) {
		...
		Navigation.findNavController(requireActivity(), R.id.hostFragment)
			.navigate(R.id.action_scheduleFragment_to_playFragment)
	}
