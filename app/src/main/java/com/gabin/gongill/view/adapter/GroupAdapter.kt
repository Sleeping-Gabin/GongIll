...
import com.gabin.gongill.databinding.GroupItemBinding
import com.gabin.gongill.databinding.GroupItemHeaderBinding
...
class GroupAdapter(
	...
	val listener: OnGroupTouchListener,
	 ...
	 */
	class ViewHolder(val binding: GroupItemBinding, val context: Context) :
	 ...
	 */
	class HeaderViewHolder(val binding: GroupItemHeaderBinding) :
		RecyclerView.ViewHolder(binding.root)
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
		return if (viewType == 0)
			...
			HeaderViewHolder(
				GroupItemHeaderBinding.inflate(
	...
	override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
		when (holder.itemViewType) {
			0 -> { //일반
				...
				binding.groupItemDescription.text =
					holder.context.getString(R.string.groupPlayInfo, allPlay.size, finishPlaySize)
