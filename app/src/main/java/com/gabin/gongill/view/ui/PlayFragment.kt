...
import com.gabin.gongill.databinding.EditDialogBinding
import com.gabin.gongill.databinding.PlayFragmentBinding
...
class PlayFragment : Fragment(), OnPointTouchListener {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		binding.playToolBar.navigationIcon =
		...
		binding.playSets.layoutManager =
