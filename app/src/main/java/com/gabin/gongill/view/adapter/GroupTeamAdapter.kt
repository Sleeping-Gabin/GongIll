...
import com.gabin.gongill.databinding.GroupDetailItemBinding
import com.gabin.gongill.view.listener.OnGroupTeamTouchListener
 ...
 */
class GroupTeamAdapter(
	teamList: List<Team>?,
	val listener: OnGroupTeamTouchListener,
	 ...
	 */
	class ViewHolder(val binding: GroupDetailItemBinding, val context: Context) :
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
		return ViewHolder(
			GroupDetailItemBinding.inflate(
	...
	override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
		...
		binding.groupDetailItemPlayInfo.text =
			holder.context.getString(R.string.groupPlayInfo, teamPlay.size, finishPlaySize)
