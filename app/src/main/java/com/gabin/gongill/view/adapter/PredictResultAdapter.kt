...
import com.gabin.gongill.databinding.PredictResultItemBinding
import com.gabin.gongill.objects.PredictResult
 ...
 */
class PredictResultAdapter(result: PredictResult) :
	 ...
	 */
	class ViewHolder(val binding: PredictResultItemBinding, val context: Context) :
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
		return ViewHolder(
			PredictResultItemBinding.inflate(
